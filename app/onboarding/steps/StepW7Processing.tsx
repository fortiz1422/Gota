...
export function StepW7Processing({ preferredCurrency, onNext }: Props) {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-bg-primary px-5 pt-safe">
      <div
        className="mb-6 h-16 w-16 rounded-full bg-primary-soft flex items-center justify-center"
        style={{ animation: 'gota-pulse 1.2s ease-in-out infinite' }}
      >
      ...
      <p className="type-body-lg text-text-primary">Preparando tu Gota...</p>
      <p className="mt-1 type-body text-text-tertiary">Configurando para vos</p>

      <style>{`
        @keyframes gota-pulse {
