...
function normalizeQuote(raw: Partial<InitialQuote>): InitialQuote | null {
  ...
  return {
    ...
    fechaActualizacion,
    rate: venta,
    effectiveDate: new Date(fechaActualizacion).toLocaleDateString('es-AR', {
      day: '2-digit',
      month: 'short',
    }),
    updatedAt: new Date(fechaActualizacion).toLocaleTimeString('es-AR', {
      hour: '2-digit',
      minute: '2-digit',
    }),
    source: 'dolarapi',
...
type LoadDashboardPageDataParams = {
