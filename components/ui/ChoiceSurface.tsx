...
export function ChoiceSurface({
  ...
  return (
    ...
    >
      <div data-choice-surface className="flex h-full min-h-0 flex-col bg-bg-primary">
        ...
        <div data-choice-scroll className="relative -mt-4 min-h-0 flex-1 overflow-y-auto overscroll-contain px-[22px] pb-8 pt-4">
          {children}
        </div>
      </div>
    </FullScreenSheet>
